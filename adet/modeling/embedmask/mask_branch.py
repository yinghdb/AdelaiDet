...
class MaskBranch(nn.Module):
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
        super().__init__()
        self.in_features = cfg.MODEL.EMBEDMASK.MASK_BRANCH.IN_FEATURES
        self.sem_loss_on = cfg.MODEL.EMBEDMASK.MASK_BRANCH.SEMANTIC_LOSS_ON
        self.num_outputs = cfg.MODEL.EMBEDMASK.MASK_BRANCH.OUT_CHANNELS
        norm = cfg.MODEL.EMBEDMASK.MASK_BRANCH.NORM
        num_convs = cfg.MODEL.EMBEDMASK.MASK_BRANCH.NUM_CONVS
        channels = cfg.MODEL.EMBEDMASK.MASK_BRANCH.CHANNELS
        ...
        tower.append(nn.Conv2d(
            channels, self.num_outputs, 3, 1, 1
        ))
